...
const SEED = [
  ...
  // City kit (KayKit City Builder Bits, CC0). `exterior` pieces build streets, `interior` pieces
  // build the floors behind the doors, so one theme serves both sides of a front door.
  {
    id: "kaykit.city.road",
    kind: "room-floor",
    tags: ["city", "floor", "exterior"],
    theme: "city",
    size: [2, 0.2, 2],
    glbUrl: "kits/kaykit/city/road.glb",
    license: "CC0-1.0",
    source: "kit",
  },
  {
    id: "kaykit.city.facade",
    kind: "wall",
    tags: ["city", "wall", "exterior"],
    theme: "city",
    size: [2, 6, 0.3],
    glbUrl: "kits/kaykit/city/facade.glb",
    license: "CC0-1.0",
    source: "kit",
  },
  {
    id: "kaykit.city.tile",
    kind: "room-floor",
    tags: ["city", "floor", "interior"],
    theme: "city",
    size: [2, 0.2, 2],
    glbUrl: "kits/kaykit/city/tile.glb",
    license: "CC0-1.0",
    source: "kit",
  },
  {
    id: "kaykit.city.plaster",
    kind: "wall",
    tags: ["city", "wall", "interior"],
    theme: "city",
    size: [2, 3, 0.3],
    glbUrl: "kits/kaykit/city/plaster.glb",
    license: "CC0-1.0",
    source: "kit",
  },
  {
    id: "kaykit.character.citizen",
    kind: "character",
    tags: ["city", "npc"],
    theme: "city",
    size: [0.5, 1.75, 0.5],
    glbUrl: "kits/kaykit/characters/citizen.glb",
    license: "CC0-1.0",
    source: "kit",
    animations: ["idle", "walk", "talk", "run"],
  },
  {
